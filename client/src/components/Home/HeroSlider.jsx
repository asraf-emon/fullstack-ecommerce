      ...
      <div className="relative h-full">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-3xl animate-fade-in-up">
            <h3 className="text-lg font-medium mb-2">{slide.subtitle}</h3>
            ...
            <Link
              to={slide.url}
              className="inline-block px-8 py-4 gradient-primary text-white rounded-lg glow-on-hover animate-smooth font-semibold text-lg"
            >
              {slide.cta}
            </Link>
          </div>
