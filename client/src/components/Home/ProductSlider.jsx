          ...
          {products.map((product) => {
            return (
              <Link
                ...
                className="shrink-0 w-80 glass-card hover:glow-on-hover animate-smooth group"
              >
                {/* Product Image */}
                <div className="relative overflow-hidden rounded-lg mb-4">
                  ...
                  <div className="absolute top-3 left-3 flex flex-col space-y-2">
                    ...
                    {product.ratings >= 4.5 && (
                      <span className="px-2 py-1 bg-linear-to-r from-yellow-400 to-rose-500 bg-primary text-primary-foreground text-xs font-semibold rounded">
                        TOP RATED
                      </span>
                    )}
                  </div>
