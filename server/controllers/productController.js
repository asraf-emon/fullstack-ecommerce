...
import fs from "fs";
import { getBdtToUsdRate } from "../utils/currencyConverter.js";
...
export const createProduct = catchAsyncError(async (req, res, next) => {
  ...
  const currentRate = await getBdtToUsdRate();
  price = parseFloat((Number(price) / currentRate).toFixed(2));
  ...
  res.status(201).json({
    ...
    conversionRate: `1 USD = ${currentRate} BDT`,
